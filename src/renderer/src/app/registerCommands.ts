...
export const registerAppCommands = (registry: CommandRegistry, ws: Workspace, ui: Ui): void => {
  registry.registerAll([
    ...
    { id: 'markdown.exportPdf', title: 'Markdown: Export PDF…', run: () => void ws.exportMarkdown(null, 'pdf') },
    { id: 'markdown.copyHtml', title: 'Markdown: Copy HTML', run: () => void ws.copyMarkdownHtml(null) },
