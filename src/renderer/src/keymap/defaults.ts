...
const common: readonly Binding[] = [
  ...
  { keys: 'mod+b', command: 'markdown.bold', when: "languageId == 'markdown' && editorFocus" },
  { keys: 'mod+i', command: 'markdown.italic', when: "languageId == 'markdown' && editorFocus" },
  { keys: 'mod+`', command: 'markdown.code', when: "languageId == 'markdown' && editorFocus" },
  { keys: 'mod+shift+c', command: 'markdown.toggleCheckbox', when: "languageId == 'markdown' && editorFocus" },
  { keys: 'mod+shift+]', command: 'markdown.headingUp', when: "languageId == 'markdown' && editorFocus" },
