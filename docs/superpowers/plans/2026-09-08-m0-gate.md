...
- [ ] **Step 3: Create package manifest and workspace settings**
...
- [ ] **Step 4: Create TypeScript and tool configs**
...
- [ ] **Step 6: Create the preload bridge (allowlist comes in Task 2; for now expose an empty object)**
...
- [ ] **Step 7: Create the renderer shell**
...
- [ ] **Step 8: Install, build, run the smoke test**
...
- [ ] **Step 1: Write failing renderer client test**
...
- [ ] **Step 4: Implement preload allowlist**
...
- [ ] **Step 5: Implement main handler wrapper and handlers**
...
- [ ] **Step 5: Implement composition observer and createEditor (no unit test — exercised by E2E in Tasks 6–7)**
...
- [ ] **Step 3: Implement perf marks in main**
...
- [ ] **Step 4: Implement renderer test hooks and App**
...
- [ ] **Step 3: Run the full local check once more and write the gate report**
